    ...
    <footer id="contato" className="pt-24 pb-8 relative">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="gradient-border rounded-3xl p-8 md:p-12 text-center mb-16">
          ...
          <a
            href="mailto:contato@nexusstudio.com"
            className="inline-flex items-center gap-2 gradient-bg px-8 py-4 rounded-full font-semibold text-primary-foreground hover:opacity-90 transition-all duration-300 hover:scale-105 glow"
          >
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full border border-border flex items-center justify-center hover:border-primary hover:bg-primary/10 transition-all duration-300"
                >
