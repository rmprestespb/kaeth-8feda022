    ...
    >
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            href="#contato"
            className="gradient-bg px-6 py-2.5 rounded-full text-sm font-semibold text-primary-foreground hover:opacity-90 transition-all duration-300 hover:scale-105 glow"
          >
            Orçamento
          </a>
        </div>
      ...
      >
        <div className="container mx-auto px-6 py-6 flex flex-col gap-4">
          ...
          <a
            href="#contato"
            onClick={() => setIsOpen(false)}
            className="gradient-bg px-6 py-3 rounded-full text-center font-semibold text-primary-foreground mt-2"
          >
            Orçamento
          </a>
        </div>
